...
This section describes the legacy "waterfall" approach to software delivery.

A significant revision is needed to reflect the Continuous Intgration / Continuous Delivery method we actually use.
...
* Unit Implemenation and Verification
...
-----|------|--------------|---------------------
01   | QP-0010|12/17/2014|Initial Release
