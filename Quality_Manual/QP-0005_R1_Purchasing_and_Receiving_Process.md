...
3.  **Training Requirements** – All Operations personnel shall be
    > trained on this procedure and training documented.

4.  **Record Management** – Purchase Order and Incoming Inspection
...
-   Description of goods, including part number, quantity, product
    ...
    1.  **Purchase Approval and Execution Procedure**
...
|------------|------------|--------------------|---------|----------------------------------------------------------------|
| 01         | QP-0005    |                    |         | Initial implementation of the Purchasing and Receiving Process |
